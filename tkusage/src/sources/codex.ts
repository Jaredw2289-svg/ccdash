...
export function parseCodexUsage(explicitCodexHome?: string, cache?: UsageCacheStore): ParsedSourceUsage {
    ...
    for (const filePath of sessionFiles) {
        ...
        if (cached) {
            ...
            if (cached.latestRateLimits
                && (!latestRateLimits || cached.latestRateLimits.timestamp > latestRateLimits.timestamp)) {
